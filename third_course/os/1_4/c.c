...
void *mythread()
{
    ...
    char *empty_message = malloc(EMPTY_MESSAGE_SIZE);
    ...
    pthread_cleanup_push(cleanup_free, empty_message);
    printf("mythread: going to clean up empty message\n");
